...
## 📜 Descripción:
Este proyecto es nuevo y pretende al menos ser una mejora tanto interna como jugablemente del anterior, mejorando la organización tanto del proyecto como de los scripts y mejorando el *game feel* mediante técnicas de *game juice* (coyote time, input buffer, etc.), además realizaré un GDD (game design document) y contaré con el programa *tiled* para realizar un mejor diseño de nivel.
